  ...
  <body style="background-color:#eeeeee">
    ...
    <div class="container">
      ...
      <div class="hero-unit" style="background-color:#CAC8C8">
        <p>1999 yılında kurulan Dünya Mühendislik Bilgisayar Sistemleri ve İletişim Sanayi Ticaret Limited Şirketi bilgisayar sektöründe, son kullanıcıdan küçük orta ve büyük boy işletmeler ve kurumlara kadar gerek yazılım ve gerek donanım alanında satış ve satış sonrası destek noktasında Samsun'da 9 yıldır hizmet vermektedir. Firmamız marka bazında DATATEKNİK Bilgisayar A.Ş nin ürettiği EXPER Bilgisayarların satış ve satış sonrası teknik hizmetlerini yüklenmekte olup, aynı zamanda oem ürünler ve sarf malzemeler noktasında da ihtiyaçlarınıza cevap verebilecek kapasitededir. Firmamızda 1 Elektronik ve Haberleşme Mühendisi, 1 Bilgisayar Mühendisi, 2 Bilgisayar yazılım teknikerleri, 3 Bilgisayar donanım teknikerleri, 1 İşletme mezunu muhasebeci, ve 2 yardımcı teknisyen personeller istihdam edilmektedir.</p>
        <p>Firmamızın misyonu kaliteden ödün vermeden, ehliyetli ve liyakatlı tecrübeli kadrosuyla Kurumların ve İşletmelerin Bilgisayar ve Ekipman ihtiyaçlarını temin edip, satış sonrası olası problemlere karşı en  kısa zamanda çözüm üretip, iş akışının aksamadan devamlılığını sağlamaktır. Müşteri memnuniyeti temel ilkemizdir.</p> 
        <p><h4>Firmamızın Faaliyet  Alanları:</h4></p>
  			<ol>
