             	...
             	<div class="hero-unit" style="background-color: #CAC8C8">
             	  <div class="row">
             	    <div class="span10" style="margin-left:50px">
             	      <div class="alert alert-block alert-error fade in" style="width:500px;height:150px;">
                      <button class="close" data-dismiss="alert">×</button>
             	        <center>
             	          <h4 class="alert-heading">Email ya da parolanız yanlış!</h4><br>
             	          <p><a class="btn btn-danger" href="Login.jsp">Tekrar Dene</a><a class="btn" href="loginkayit.jsp">Üye olmak için</a></p>
             	        </center>
             	      </div>
             	    </div>
             	  </div>
             	  ...
             	  <div class="span10" style="margin-left:50px">
                    ...
                    <button class="close" data-dismiss="alert">×</button>
             	      <center>
             	        ...
             	        <p><a class="btn btn-danger" href="Login.jsp">Tekrar Dene</a><a class="btn" href="Loginkayit.html">Üye olmak için</a></p>
             	      </center>
             	    </div>
             	  </div>
             	</div>
